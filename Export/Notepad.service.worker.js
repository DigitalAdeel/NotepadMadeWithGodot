...
const CACHE_NAME = "Notepad-cache";
const OFFLINE_URL = "Notepad.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Notepad.html","Notepad.js","Notepad.wasm","Notepad.pck","Notepad.offline.html","Notepad.icon.png","Notepad.apple-touch-icon.png"];
